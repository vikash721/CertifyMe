...
import { useIssueCertificate } from "./payment-dep/issueCertificate";
...
export default function PaymentModal({ isOpen, onClose, amount = 199, currency = "USD", onPaymentComplete, formData }) {
    ...
    const { isProcessing, isComplete, setIsProcessing, setIsComplete } = useCertifyMeStore();
            ...
            >
                ...
                >
                    ...
                    <div className="p-6">
                        ...
                        {step === 2 && paymentMethod === "crypto" && isProcessing && (
